...
class UpdateCourse extends Component {
            ...
            <React.Fragment>
                <div className="col-md-4 mt-4 container">
                    <form className="text-center border border-light p-5" onSubmit={this.addCourse}
                        ...
                        <button onClick={this.loadCourse} className="btn btn-primary btn-block mb-3" type="button">Load</button>
                        ...
                        <div class="form-check mt-5">
                            ...
                            <label class="form-check-label" for="shouldUpdateContentInputField">Replace Content</label>
                        </div>
                        ...
                        <button className="btn btn-info btn-block" type="submit">Update course</button>
                    </form>
                </div>
            </React.Fragment>
        )
    ...
    loadCourse = event => {
        ...
        fetch(process.env.REACT_APP_URL + "/courses/" + this.state.name, {
            ...
            const formOfEducationInputField = document.getElementById('formOfEducationInputField');
            formOfEducationInputField.value = courseMap['formOfEducation'];
            ...
            this.setState({
                ...
                formOfEducation: formOfEducationInputField.value,
